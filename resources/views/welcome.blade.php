...
<head>
  ...
  <link href="{{asset('assets/frontend/styles/main.css')}}" rel="stylesheet" type="text/css">
	...
	<section class="relative">
		<div class="container mx-auto flex flex-col lg:flex-row items-center gap-12 mt-10">
		  ...
		  <div class="flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0 z-10">
			<img class="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full fadeInRotate" src="{{asset('assets/frontend/images/hero-dish.png')}}" alt="" />
		  </div>
		</div>
		<!-- Rounded Rectangle -->
		<div
